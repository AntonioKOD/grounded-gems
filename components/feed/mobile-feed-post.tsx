      ...
      <AnimatePresence>
        {showActions && (
          <motion.div
            ...
            className="absolute right-3 bottom-24 flex flex-col items-center space-y-4 z-20"
          >
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.15 }}
              whileTap={{ scale: 0.85 }}
              transition={{ type: "spring", stiffness: 600, damping: 20, delay: 0.3 }}
              className="group relative"
              onClick={handleSave}
              disabled={isSaving}
            >
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.15 }}
              whileTap={{ scale: 0.85 }}
              transition={{ type: "spring", stiffness: 600, damping: 20, delay: 0.4 }}
              className="group relative"
              onClick={(e) => {
                e.stopPropagation()
                setShowActions(true)
                // Could open a quick actions menu
              }}
            >
              <div className="relative p-3 rounded-full backdrop-blur-xl bg-white/15 border border-white/30 hover:bg-white/25 transition-all duration-300 shadow-2xl">
