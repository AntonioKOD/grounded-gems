...
export async function GET(
  ...
  try {
    ...
    // Debug logging
    console.log('🔍 [Followers API] Authorization header:', authHeader)
    console.log('🔍 [Followers API] Cookie header:', cookieHeader)
    console.log('🔍 [Followers API] Cookie includes payload-token:', cookieHeader?.includes('payload-token='))
    ...
    try {
      ...
      console.log('🔐 [Followers API] Direct Payload authentication successful')
    } catch (authError) {
      console.log('❌ [Followers API] Direct Payload authentication failed:', authError instanceof Error ? authError.message : String(authError))
    }
